...
//
//    @Test
//    void execute_deleteValidBook_success() {
//        DeleteByBookCommand command = new DeleteByBookCommand("Title", "Author");
//        command.execute(library, ui, storage, memberManager);
//        assertEquals(0, library.getBooks().size());
//    }
//
//    @Test
//    void undo_deleteValidBook_success() {
//        DeleteByBookCommand command = new DeleteByBookCommand("Title", "Author");
//        command.execute(library, ui, storage, memberManager);
